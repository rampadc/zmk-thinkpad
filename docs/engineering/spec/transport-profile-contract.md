...
> **Status: implemented.** This contract applies to the T430 and T470 DK
> targets and the T430 and T60 Revision A targets.

This page defines transport and profile behavior for every keyboard in this
repository.
...
[`dk-and-serial-debugging.md`](../architecture/programming/dk-and-serial-debugging.md). Copying firmware to `/Volumes/JLINK` is a
...
- T430, T470, and T60 must implement the same command semantics. T60 inherits
  the T430 Revision A profile controller and LED behavior.

## Required regression transitions

Test each transition on T430 and T470. Test T60 separately when a change can
affect its Revision A keymap, status LEDs, or shared profile controller:
